...
bool Read_Home_Switch(uint8_t motor,uint8_t dir)
{
	bool ret;
	switch(motor)
	{
		case 0:
			ret = !((!(dir>0))|(GPIO_ReadInputDataBit(GPIOB, GPIO_Pin_12)>0));
			break;
		case 1:
			ret = !((!(dir>0))|(GPIO_ReadInputDataBit(GPIOB, GPIO_Pin_13)>0));
			break;
		case 2:
			ret = !((!(dir>0))|(GPIO_ReadInputDataBit(GPIOB, GPIO_Pin_14)>0));
			break;
		case 3:
			ret = !((!(dir>0))|(GPIO_ReadInputDataBit(GPIOB, GPIO_Pin_15)>0));
			break;
		case 4:
			ret = !((!(dir>0))|(GPIO_ReadInputDataBit(GPIOA, GPIO_Pin_2)>0));
			break;
		case 5:
			ret = !((!(dir>0))|(GPIO_ReadInputDataBit(GPIOA, GPIO_Pin_1)>0));
			break;			
	}
